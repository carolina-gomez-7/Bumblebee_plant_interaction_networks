...
bmat = read_csv("allbees_vs_plants_7_oct_2024_2.csv")

plant_species_order <- c("Epilobium angustifolium", "Centaurea nigra", "Lavandula angustifolia", "Lotus corniculatus", "Cirsium arvense",
                         "Impatiens glandulifera", "Symphoricarpos albus", "Geranium pratense", "Ligustrum vulgare", "Trifolium repens", 
                         "Ballota nigra", "Rubus fruticosus agg.", "Tilia sp", "Calystegia silvatica", "Jacobea vulgaris", "Raphanus sativus",
                         "Vicia cracca", "Cirsium vulgare", "Cyanus segetum", "Heracleum sphondylium", "Rhinanthus minor", "Buddleja davidii",
                         "Hypericum perforatum", "Nepeta racemosa", "Primula bulleyana", "Salvia yangii", "Cistus salvifolius", "Cornus sanguinea",
                         "Hydrangea paniculata", "Salvia rosmarinus", "Trifolium pratense", "Arcticum minus", "Cotoneaster × suecicus", "Echium pininana",
                         "Phacelia tanacetifolia", "Ranunculus acris", "Rhododendron ponticum", "Stachys palustris", "Veronica spicata", "Centranthus ruber",
                         "Cistus sp", "Filipendula ulmaria", "Lapsana communis", "Lathyrus pratensis", "Linum usitatissimum", 
                         "Papaver rhoeas", "Rhododendron sp1", "Rhododendron sp2", "Rubus caesius", "Silene dioica", "Veronica albicans",
                         "Campanula latifolia", "Cardamine pratensis", "Cistus creticus", "Iris sp",
                         "Odontites sp", "Prunella vulgaris", "Rhododendron van", "Sinapis alba", "Vicia sepium")
